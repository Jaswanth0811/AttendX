...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsActionCard(Icons.Default.Backup, "Backup Data to Device",
                "Save database to Downloads") { viewModel.backupDatabase() }

            SettingsActionCard(Icons.Default.Restore, "Restore from Device",
                "Restore database from file") { documentLauncher.launch("*/*") }

            SettingsActionCard(Icons.Default.Backup, "Backup to Google Drive",
                "Save database to cloud") { viewModel.backupToGoogleDrive() }

            SettingsActionCard(Icons.Default.Restore, "Restore from Google Drive",
                "Restore database from cloud") { viewModel.restoreFromGoogleDrive() }
