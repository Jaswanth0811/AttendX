...
class PeriodNotificationReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val mainIntent = Intent(context, com.attendx.app.MainActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
            putExtra("navigate_to", "attendance_entry")
        }
        ...
        val builder = NotificationCompat.Builder(context, PeriodNotificationManager.CHANNEL_ID)
            ...
            .setContentText("Your period $periodNum has just ended. Tap to mark attendance.")
